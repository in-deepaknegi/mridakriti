  ...
  return (
    <section className='overflow-hidden bg-black py-16 sm:py-20'>
      <div className='mx-auto px-6 lg:px-8'>
        <h2 className='text-4xl font-bold tracking-tight text-gray-100 sm:text-5xl'>Our Upcoming Work</h2>
        <div className='mx-auto mt-10 grid gap-x-8 gap-y-8 sm:gap-y-20 lg:mx-0 lg:max-w-none grid-cols-12'>
          <div className='col-span-12 order-last lg:order-first lg:pr-8 lg:col-span-7'>
            <div className=''>
              ...
              <div className="mt-10 flex gap-x-6">
                ...
                <a href="/explore/rafting" className="text-sm font-semibold leading-6 text-gray-200 my-auto"
          ...
          <div className='my-auto -mt-[5rem] col-span-12 order-first lg:order-last lg:col-span-5'>
