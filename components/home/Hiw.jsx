            ...
            <div className='mx-auto max-w-7xl px-6 lg:px-8'>
                <div className='relative isolate flex flex-col lg:flex-row'>
                    <div className='max-w-3xl'>
                        <h2 className='text-left text-3xl font-bold tracking-wide text-gray-100 sm:text-4xl'>
                            The process of creating soil paiting
                        </h2>

                        <p className='mt-4 max-w-xl text-left text-sm text-gray-400 sm:text-base'>
                    ...
                    <div className='mt-16  text-white max-w-xl lg:px-8 lg:mt-0'>
                        <div className='mx-auto flex flex-col gap-y-10'>
                            <div className='flex gap-2 md:gap-6'>
                                ...
                                <div>
                                    <p className='text-lg font-semibold leading-8 tracking-tight text-gray-200'>
                                        Gathering Soil and Materials:
                                    </p>
                                    <p className='mt-2 text-[0.925rem] leading-6 text-gray-400'>
