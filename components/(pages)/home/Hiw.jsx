...
const steps = [
    {
        ...
        description: "Collect different types of soil in various colors and textures. You'll also need a canvas or sturdy paper, brushes, adhesive (like glue or Mod Podge), and containers for mixing"
    },
    {
        id: 2,
        title: "Preparing the Soil Palette:",
        description: "Break down the soil into fine particles to create a diverse palette. Use separate containers for each color of soil and mix them with water or adhesive to create a paste-like consistency."
    },
    {
        id: 3,
        title: "Painting Process:",
        description: "Begin by sketching your design lightly on the canvas. Then, use brushes to apply the prepared soil paste onto the canvas, layering and blending different colors to create depth and texture. You can use various techniques like stippling, blending, or layering to achieve different effects."
    },
    {
        id: 4,
        title: "Finishing Touches:",
        description: "Let the painting dry completely. Once dry, you might want to add a protective coating or sealant to preserve the artwork and enhance its longevity. Frame the painting if desired to showcase its beauty."
    },
]
        ...
        <section className='relative bg-dusk-200/60  py-16 lg:py-24'>
            <div className='mx-auto max-w-7xl px-6 lg:px-8'>
                <div className='relative isolate flex flex-col lg:flex-row'>
                    ...
                    <div className='mt-16 text-black max-w-xl lg:px-8 lg:mt-0'>
                            ...
                            {steps.map((step) => (
                                <div key={step.id}
                                    ...
                                    <div className='items-center text-soil-100'>
                                        ...
                                        <div className='mt-2 h-full w-[2px] bg-soil-100/70 lg:static mx-auto'></div>
                                    </div>
                                    <div>
