...
import Profile1 from '@/public/profiles/profile1.jpg';

const Testimonial = () => {
    return (
        <section className='isolate overflow-hidden bg-black py-20 lg:py-10'>
            <div className='mx-auto max-w-7xl px-6 lg:px-8'>
                <h2 className='text-white text-3xl font-semibold sm:text-4xl'>Words from Our Clients</h2>
            </div>

            <div className='relative mx-auto max-w-xl px-6 py-16 sm:py-24 md:px-0 lg:max-w-2xl'>
                <figure className='items-center gap-8'>
                    <div className='col-span-2 font-sans'>
                        <div className='relative'>
                            <svg viewBox="0 0 162 128" fill="none" aria-hidden="true" className='absolute h-32 z-[-10] top-[-3rem] stroke-slate-700'>
                            ...
                            <blockquote className='text-xl text-center sm:text-2xl sm:leading-8 text-gray-100'>
                                <p>
                        ...
                        <figcaption className='mt-8 flex mx-auto items-center justify-center'>
                            <Image
                                src={Profile1}
                                alt='profile-1'
                            ...
                            <div className='h-10 bg-gray-400 w-[1px] mx-3'></div>
                            <div className='flex'>
